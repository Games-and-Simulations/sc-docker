...
function update_registry() {
    ...
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Blizzard Entertainment\Starcraft" /v Gamma /t REG_DWORD /d 0000008c
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Blizzard Entertainment\Starcraft" /v ColorCycle /t REG_DWORD /d 00000001
    ...
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Blizzard Entertainment\Starcraft" /v music /t REG_DWORD /d 0000002d
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Blizzard Entertainment\Starcraft" /v sfx /t REG_DWORD /d 0000001e
    ...
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Blizzard Entertainment\Starcraft" /v StarEdit /t REG_DWORD /d "Z:\app\sc\StarEdit.exe"
    ...
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Blizzard Entertainment\Starcraft\DelOpt1" /v File0 /t REG_EXPAND_SZ /d "sng"
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Blizzard Entertainment\Starcraft\DelOpt1" /v File1 /t REG_EXPAND_SZ /d "mlt"
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Blizzard Entertainment\Starcraft\DelOpt1" /v File2 /t REG_EXPAND_SZ /d "snx"
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Blizzard Entertainment\Starcraft\DelOpt1" /v File3 /t REG_EXPAND_SZ /d "mlx"
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Blizzard Entertainment\Starcraft\DelOpt1" /v Path0 /t REG_EXPAND_SZ /d "Z:\app\sc\Save"
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Blizzard Entertainment\Starcraft\DelOpt1" /v Path1 /t REG_EXPAND_SZ /d "Z:\app\sc\Map\Save"
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Blizzard Entertainment\Starcraft\DelOpt1" /v Path2 /t REG_EXPAND_SZ /d "Z:\app\sc\Save"
    wine REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Blizzard Entertainment\Starcraft\DelOpt1" /v Path3 /t REG_EXPAND_SZ /d "Z:\app\sc\Maps\Save"
}
