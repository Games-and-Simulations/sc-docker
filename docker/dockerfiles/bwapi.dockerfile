...
ENV BOT_DATA_SAVE_DIR="$BWAPI_DATA_DIR/save"
...
RUN mkdir -m 750 $BWAPI_DATA_BWTA_DIR $BWAPI_DATA_BWTA2_DIR $MAP_DIR $BOT_DIR $BOT_DATA_READ_DIR $BOT_DATA_WRITE_DIR $BOT_DATA_AI_DIR
VOLUME $BWAPI_DATA_BWTA_DIR $BWAPI_DATA_BWTA2_DIR $MAP_DIR $BOT_DIR
RUN echo "umask 0027" >> /home/starcraft/.bashrc

USER root
RUN mkdir -m 755 $BOT_DATA_SAVE_DIR $BOT_DATA_LOGS_DIR
RUN chown bot:bot $BOT_DATA_SAVE_DIR $BOT_DATA_LOGS_DIR -R
VOLUME $BOT_DATA_SAVE_DIR $BOT_DATA_LOGS_DIR
